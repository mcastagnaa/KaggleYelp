...
SELECT	R.Review_id
	...
	--+ (3.6887788888 - 3.67452543988905 + 0.0001212259 * 
		(CASE WHEN CH.Checkin_count IS NULL THEN 0 ELSE CH.Checkin_count END))
	...
	+ 0.5 * (CASE LonLat.avgBias WHEN NULL THEN 0 ELSE LonLat.avgBias END) 
